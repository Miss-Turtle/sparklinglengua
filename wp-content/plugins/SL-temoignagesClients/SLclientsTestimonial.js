(function($){
    ...
    $('input[type=submit]').click(function(){
        ...
        //on vérifie que la societe est renseignée sinon on fait appara^tre une alerte
        if($('#societe').val() !== ''){
            $('.societe').hide();
        } else {
            $('.societe').show();
        ...
        //on vérifie que le nom est renseigné sinon on fait appara^tre une alerte
        if($('#nom').val() !== ''){
            $('.nom').hide();
        } else {
            $('.nom').show();
        ...
        //on vérifie que le logo est chargé sinon on fait apparaître une alerte
        if($('input#logo').val() !== ''){alert($('#logo').val().html());
            $('.logo').hide();
        } else {
            $('.logo').show();
            return invalid;
