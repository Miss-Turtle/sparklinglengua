(function($){
    ...
    $('#LSbtnHover').click(function(){
        ...
        $('#enTableMemberTeam').hide(); 
        $('#deTableMemberTeam').hide(); 
        $('#esTableMemberTeam').hide();
        $('#itTableMemberTeam').hide(); 
        $('#frTableMemberTeam').hide(); 
        $('#nlTableMemberTeam').hide();
        $('#enParagrapheMemberTeam').hide(); 
        $('#deParagrapheMemberTeam').hide(); 
        $('#esParagrapheMemberTeam').hide();
        $('#itParagrapheMemberTeam').hide(); 
        $('#frParagrapheMemberTeam').hide(); 
        $('#nlParagrapheMemberTeam').hide();
    });
