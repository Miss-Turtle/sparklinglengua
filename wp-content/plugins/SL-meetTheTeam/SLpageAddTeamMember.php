...
<form action="admin.php?page=SLaddMemberTeam" method="post" enctype="multipart/form-data">
    ...
    <table id="formTableAddMember">
        ...
        <tr>
            ...
            <td><input id="nom" name="nom" type="text" value="<?php print($nom); ?>" autocomplete="off" required/></td>
        ...
        <tr>
            ...
            <td><input id="prenom" name="prenom" type="text" value="<?php print($prenom); ?>" autocomplete="off" required/></td>
        ...
        <tr>
            ...
            <td><input id="statuts" name="statuts" type="text" value="<?php print($statuts); ?>" autocomplete="off" required/></td>
        ...
        <tr>
            ...
            <td><input id="email" name="email" type="email" value="<?php print($email); ?>" placeholder="mail@domain.com" autocomplete="off" required/></td>
